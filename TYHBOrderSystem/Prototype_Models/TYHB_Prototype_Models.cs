namespace TYHBOrderSystem.Prototype_Models
{
				...
				public partial class TYHB_Prototype_Models : DbContext
				{
								public TYHB_Prototype_Models()
												: base("name=TYHB_Prototype_Models")
								{
								}

								public virtual DbSet<CAKE_FINISHINGS> CAKE_FINISHINGS { get; set; }
								...
								{
												modelBuilder.Entity<CAKE_FINISHINGS>()
																.Property(e => e.Type_Of_Finish)
																.IsUnicode(false);

												modelBuilder.Entity<CAKE_FINISHINGS>()
																.Property(e => e.Description_Of_Finish)
																.IsUnicode(false);
												...
												modelBuilder.Entity<WTBO_HISTORY>()
																.Property(e => e.Wedding_Cake_Description)
																.IsUnicode(false);
								}
				}
}
